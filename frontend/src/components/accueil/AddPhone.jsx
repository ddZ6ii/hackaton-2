...
export default function AddPhone({
  ...
  return (
    <form className="bg-neutralLightest dark:bg-primaryDark flex h-full flex-col items-center justify-center gap-4 px-12 text-center ">
      ...
      <input
        type="email"
        placeholder="Email"
        className=" dark:bg-neutralLightest w-full rounded border-none bg-neutralLight p-3 outline-none"
        id="email-login"
        value={email}
